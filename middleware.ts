...
export function middleware(req: NextRequest) {
  ...
  const csp = [
    ...
    `style-src-elem 'self' 'unsafe-inline' https://fonts.googleapis.com https://www.clarity.ms https://c.clarity.ms https://scripts.clarity.ms${allowGoogleAnalyticsEndpoints ? " https://www.googletagmanager.com" : ""}`,
    ...
    `connect-src 'self' https://api.razorpay.com https://*.razorpay.com https://db.prisma.io https://*.upstash.io https://www.clarity.ms https://c.clarity.ms https://l.clarity.ms https://scripts.clarity.ms${allowGoogleAnalyticsEndpoints ? " https://www.google-analytics.com https://www.googletagmanager.com" : ""}`,
