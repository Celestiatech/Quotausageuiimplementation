...
export function middleware(req: NextRequest) {
  ...
  const csp = [
    ...
    `script-src 'self' 'unsafe-inline' 'unsafe-eval' https://checkout.razorpay.com https://www.clarity.ms https://c.clarity.ms${hasGoogleAnalytics ? " https://www.googletagmanager.com" : ""}`,
    `connect-src 'self' https://api.razorpay.com https://*.razorpay.com https://db.prisma.io https://*.upstash.io https://www.clarity.ms https://c.clarity.ms${hasGoogleAnalytics ? " https://www.google-analytics.com https://www.googletagmanager.com" : ""}`,
