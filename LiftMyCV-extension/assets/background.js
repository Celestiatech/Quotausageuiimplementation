...
(() => {
  ...
  var C = (e, t, n) => (_e(e, typeof t != "symbol" ? t + "" : t, n), n);
  var se = Ae((Tt, B) => {
    "use strict";
    ...
    c.prototype.emit = function (t) {
      ...
      if (typeof u == "function") Q(u, this, n);
      else
        for (var l = u.length, f = ae(u, l), a = 0; a < l; ++a)
          Q(f[a], this, n);
      return !0;
    };
    function Y(e, t, n, a) {
    ...
    c.prototype.once = function (t, n) {
      return (A(n), this.on(t, ee(this, t, n)), this);
    };
    c.prototype.prependOnceListener = function (t, n) {
      return (A(n), this.prependListener(t, ee(this, t, n)), this);
    };
    c.prototype.removeListener = function (t, n) {
      ...
      if (a === n || a.listener === n)
        --this._eventsCount === 0
          ...
          : (delete o[t],
            o.removeListener &&
              this.emit("removeListener", t, a.listener || n));
        ...
        (s === 0 ? a.shift() : Fe(a, s),
          a.length === 1 && (o[t] = a[0]),
          o.removeListener !== void 0 &&
            this.emit("removeListener", t, i || n));
      }
      return this;
    };
    ...
    c.prototype.removeAllListeners = function (t) {
      ...
      if (arguments.length === 0) {
        ...
        for (o = 0; o < s.length; ++o)
          ((r = s[o]), r !== "removeListener" && this.removeAllListeners(r));
        return (
    ...
    function Be(e, t) {
      return new Promise(function (n, a) {
        ...
        (oe(e, t, s, { once: !0 }), t !== "error" && Ke(e, o, { once: !0 }));
      });
    }
    function Ke(e, t, n) {
      typeof e.on == "function" && oe(e, "error", t, n);
    }
    function oe(e, t, n, a) {
  ...
  var je = (() => {
    ...
    re = 4096;
  function ie() {
    (K === void 0 || E + 16 > re) && ((E = 0), (K = je(re)));
    let e = Array.prototype.slice.call(K, E, (E += 16));
    return (
      (e[6] = (e[6] & 15) | 64),
      (e[8] = (e[8] & 63) | 128),
      p[e[0]] +
  ...
  var qe = {
      ...
      string: (e) => 2 * e.length,
      object: (e) =>
        e ? Object.keys(e).reduce((t, n) => j(n) + j(e[n]) + t, 0) : 0,
    },
    j = (e) => qe[typeof e](e),
    x = class extends ce.EventEmitter {
      constructor(t) {
        (super(),
      ...
      send(t, n) {
        return this._send([{ event: t, payload: n }]);
      }
      getEvents() {
        return this._events;
      }
      on(t, n) {
        return super.on(t, (a) => {
          n({ ...a, respond: (o) => this.send(a.eventResponseKey, o) });
        });
      }
      _emit(t) {
      ...
      _nextSend() {
        ...
        return new Promise((s, r) => {
          ...
          try {
            let l = t.map((f) => ({
              ...f,
              payload: { data: f.payload, eventResponseKey: o },
            }));
            this.wall.send(l);
          } catch (l) {
            ...
            if (l.message === f && Array.isArray(n.payload)) {
              let k = j(n);
              if (k > this._maxMessageSize) {
                let w = Math.ceil(k / this._maxMessageSize),
                  m = Math.ceil(n.payload.length / w),
                  D = n.payload;
                for (let M = 0; M < w; M++) {
                  let F = Math.min(D.length, m);
                  this.wall.send([
                    {
                      event: n.event,
                      payload: {
                        _chunkSplit: { count: w, lastChunk: M === w - 1 },
                        data: D.splice(0, F),
                      },
                    },
                  ]);
  ...
  var He = chrome.runtime.getURL("assets/config.js"),
    ue,
    L = (ue = globalThis.browser) != null ? ue : globalThis.chrome;
  async function We() {
    var V, $;
    let e = await L.storage.local.get("defaultConfig");
    if ((V = e.defaultConfig) != null && V.apiKey) return e.defaultConfig;
    let t = {},
      ...
      o = /\/\*[\s\S]*?\*\/|([^:]|^)\/\/.*$/gm,
      i = (await (await fetch(He)).text()).replace(o, ""),
    ...
    (l
      ...
      .forEach((Re) => {
        let [P, z] = Re.split(":");
        if (P && z) {
          let v = z.replaceAll("'", "").replaceAll('"', "");
          for (let y = 0; y < n.length; y++)
            P.endsWith(n[y]) && (v = Number(v));
          for (let y = 0; y < a.length; y++)
            P.startsWith(a[y]) && (v = v === "true");
          t[P] = v;
        }
      }),
      (m = m.replaceAll("'", "").replaceAll('"', "")));
    let F = m.indexOf(":["),
      xe = m.slice(F + 2, m.length - 1);
    t.blackUrlList = xe.split(",");
    let S = await L.storage.local.get("config");
    return (
      ($ = S == null ? void 0 : S.config) != null &&
        $.apiKey &&
        (t.apiKey = S.config.apiKey),
      L.storage.local.set({ defaultConfig: t }),
      t
    );
  }
  var R = {
  ...
  async function pe() {
    let e = await We(),
      t = Object.keys(e);
    for (let n of t)
      if (!(n === "proxyType" && !le[n].includes(e[n]))) {
        {
          if (n.endsWith("Mode") && !le.mode.includes(e[n])) continue;
          if (n === "port") {
            if (typeof e.port != "number") continue;
            R.port = e.port;
          }
        }
        Reflect.has(R, n) && typeof R[n] == typeof e[n] && (R[n] = e[n]);
      }
    return R;
  }
  var Ge = pe(),
    h = {
      ...
      async getAll() {
        let e = await pe(),
          t = await L.storage.local.get("config");
        return h.joinConfig(e, t.config);
      },
      async set(e) {
        let t = await h.getAll(),
          n = h.joinConfig(t, e);
        return L.storage.local.set({ config: n });
      },
      joinConfig(e, t) {
        let n = {};
        if (e) for (let a in e) n[a] = e[a];
        if (t) for (let a in t) n[a] = t[a];
        return n;
      },
    };
  function fe(e) {
    e.on("config", async ({ respond: t }) => {
      let n = await h.getAll();
      t(n).then();
    });
  }
  function de(e) {
  ...
  var q = class {
      ...
      async getOrCreateClientId() {
        let { clientId: t } = await chrome.storage.local.get("clientId");
        return (
          t ||
            ((t = self.crypto.randomUUID()),
            await chrome.storage.local.set({ clientId: t })),
          t
        );
      }
      async getOrCreateSessionId() {
        ...
        return (
          t &&
            t.timestamp &&
            ((n - t.timestamp) / 6e4 > 30
              ? (t = null)
              : ((t.timestamp = n),
                await chrome.storage.session.set({ sessionData: t }))),
          t ||
            ((t = { session_id: n.toString(), timestamp: n.toString() }),
            await chrome.storage.session.set({ sessionData: t })),
          t.session_id
        );
      }
  ...
  var d = class {
    ...
    async getBalance() {
      ...
      if (
        ...
        ((a = t.data) == null ? void 0 : a.errorId)
      )
        throw new Error(
          ((o = t.data) == null ? void 0 : o.errorDescription) ||
            "createTask fail\uFF01",
        );
      return t.data;
    }
    async createTaskResult(t, n) {
      ...
      let o = await this.createTask(t),
        ...
        u =
          n.pollingInterval === void 0
            ? this.options.pollingInterval
            : n.pollingInterval;
      for (; !(this.getTime() - r > i); ) {
        await new Promise((f) => setTimeout(f, u * 1e3));
        let l = await this.getTaskSolution({ taskId: s });
    ...
    async createTask(t) {
      ...
      if (
        s.status !== 200 ||
        ((i = s.data) == null ? void 0 : i.errorCode) ||
        ((u = s.data) == null ? void 0 : u.errorId)
      )
        throw new Error(
          ((l = s.data) == null ? void 0 : l.errorCode) ||
            "createTask fail\uFF01",
        );
    ...
    async getTaskSolution({ taskId: t }) {
      ...
      if (
        n.status !== 200 ||
        ((a = n.data) == null ? void 0 : a.errorCode) ||
        ((o = n.data) == null ? void 0 : o.errorId)
      )
        throw new Error(
          ((s = n.data) == null ? void 0 : s.errorCode) ||
            "getTaskResult fail\uFF01",
        );
      return n.data;
    }
    async createRecognitionTask(t) {
      ...
      if (
        r.status !== 200 ||
        ((u = r.data) == null ? void 0 : u.errorCode) ||
        ((l = r.data) == null ? void 0 : l.errorId) !== 0
      )
        throw new Error(
          ((f = r.data) == null ? void 0 : f.errorCode) ||
            "createTask fail\uFF01",
        );
  ...
  function O(e, t) {
    ...
    return new Promise((o) => {
      n.tabs.query({ active: !0, currentWindow: !0 }).then((s) => {
        if (globalThis != null && globalThis.browser)
          browser.tabs.sendMessage(e, { command: t }).then((r) => {
            o(r);
          });
        else {
          let r = s.find((u) => u.id === e);
          ((r == null ? void 0 : r.url) || o(!1),
            chrome.tabs.sendMessage(e, { command: t }, (u) => {
              o(u);
            }));
        }
      });
      ...
      h.getAll().then((o) => {
        switch (a) {
          ...
          case "execute":
            ...
            break;
          case "solved":
            ye({ response: { action: "solved", callback: o.solvedCallback } });
            break;
          case "updateMenu":
            I(t.tab.id);
            break;
  ...
  async function et(e) {
    let t = await H.getOrCreateSessionId();
    H.fireEvent(e, { session_id: t });
  }
  var Ce,
    me = (Ce = globalThis.browser) != null ? Ce : globalThis.chrome;
  async function ye(e) {
    let t = await me.tabs.query({ currentWindow: !0, active: !0 });
    for (let n of t) me.tabs.sendMessage(n.id, e);
  }
  async function tt(e, t) {
    let { captchaType: n, widgetId: a, params: o, action: s } = e,
      r = { action: s, request: { captchaType: n, widgetId: a } };
    if (!o) return ((r.error = "params is error!"), r);
    try {
      r.response = await Te(n, o, t);
    } catch (i) {
      r.error = String(i);
    }
    return r;
  ...
  async function nt(e, t) {
    let n = {
      ...
      request: { captchaType: "cloudflare", widgetId: "0" },
    };
    try {
      n.response = await Te(
        "cloudflare",
        { sitekey: e.sitekey, websiteURL: e.websiteURL },
        t,
      );
    } catch (a) {
      n.error = String(a);
  ...
  async function rt(e) {
    var a;
    let t = await d.API();
    ((a = e.websiteURL) == null ? void 0 : a.indexOf("tbi.com.iq")) !== -1 &&
      (e.websiteURL = "https://apps.tbi.com.iq/dollar/register.aspx");
    let n = {
      type: "ReCaptchaV2TaskProxyLess",
      websiteURL: e.websiteURL,
      websiteKey: e.sitekey,
      invisible: e.invisible,
      enterprisePayload: { s: e.s },
      metadata: { pageURL: b.pageURL, title: b.title },
    };
    return (
      e.action && (n.pageAction = e.action),
      await t.createTaskResult({ task: n })
    );
  }
  async function it(e) {
    var a;
  ...
  async function ft(e) {
    var a;
    let t = await d.API();
    ((a = e.url) == null ? void 0 : a.indexOf("tbi.com.iq")) !== -1 &&
      (e.url = "https://apps.tbi.com.iq/dollar/register.aspx");
    let n = {
    ...
    return await t.createRecognitionTask({ task: n });
  }
  async function dt(e) {
    let t = await d.API(),
      n = await h.getAll();
  ...
  var ke,
    G = (ke = globalThis.browser) != null ? ke : globalThis.chrome,
    W = "";
  async function gt() {
    return "1.16.0";
  }
  chrome.runtime.onConnect.addListener(async () => {
    (W || (W = await gt()), G.storage.local.set({ version: W }));
  });
  chrome.runtime.onMessage.addListener(we);
  function mt() {

  }
  G.tabs.onActivated.addListener(({ tabId: e }) => {
    I(e);
  });
  G.tabs.onUpdated.addListener((e, t) => {
    t.status === "complete" && I(e);
  });
  function yt(e) {
  ...
  var g = {},
    Ct = (e) => {
      ...
      return (
        a || (a = g[n] = {}),
        (a[e.name] = { port: e, connected: !0, listening: !1 }),
        a[e.name]
      );
    };
  chrome.runtime.onConnect.addListener((e) => {
    ...
    let n = new x({
      listen(a) {
        for (let o in g) {
          ...
          (s.app &&
            !s.app.listening &&
            ((s.app.listening = !0), s.app.port.onMessage.addListener(a)),
            s.contentScript &&
              !s.contentScript.listening &&
              (s.contentScript.port.onMessage.addListener(a),
      ...
      send(a) {
        for (let o in g) {
          ...
          (s.app && s.app.connected && s.app.port.postMessage(a),
            s.contentScript &&
              s.contentScript.connected &&
              s.contentScript.port.postMessage(a));
        }
      },
    });
    ve(n, g);
    for (let a in g) {
      let o = g[a];
      o.app && o.contentScript && bt(o.app, o.contentScript);
    }
  });
  function bt(e, t) {
