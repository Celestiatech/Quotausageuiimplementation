...
(() => {
  ...
  var We = (e, t, n) => (
    ...
    qe(
      t || !e || !e.__esModule
        ? oe(n, "default", { value: e, enumerable: !0 })
        : n,
      e,
    )
  );
  var me = Ue((wt, U) => {
    ...
    c.prototype.emit = function (t) {
      ...
      if (typeof u == "function") re(u, this, n);
      else
        for (var l = u.length, f = pe(u, l), o = 0; o < l; ++o)
          re(f[o], this, n);
      return !0;
    };
    function ce(e, t, n, o) {
    ...
    c.prototype.once = function (t, n) {
      return (O(n), this.on(t, le(this, t, n)), this);
    };
    c.prototype.prependOnceListener = function (t, n) {
      return (O(n), this.prependListener(t, le(this, t, n)), this);
    };
    c.prototype.removeListener = function (t, n) {
      var o, r, i, a, s;
      if ((O(n), (r = this._events), r === void 0)) return this;
      ...
      if (o === n || o.listener === n)
        --this._eventsCount === 0
          ...
          : (delete r[t],
            r.removeListener &&
              this.emit("removeListener", t, o.listener || n));
    ...
    function Ge(e, t) {
      return new Promise(function (n, o) {
        ...
        (de(e, t, i, { once: !0 }), t !== "error" && Xe(e, r, { once: !0 }));
      });
    }
    function Xe(e, t, n) {
  ...
  var Ye = (() => {
    ...
    he = 4096;
  function ge() {
    (q === void 0 || I + 16 > he) && ((I = 0), (q = Ye(he)));
    let e = Array.prototype.slice.call(q, I, (I += 16));
    return (
      (e[6] = (e[6] & 15) | 64),
      (e[8] = (e[8] & 63) | 128),
      d[e[0]] +
  ...
  var Je = {
      ...
      string: (e) => 2 * e.length,
      object: (e) =>
        e ? Object.keys(e).reduce((t, n) => W(n) + W(e[n]) + t, 0) : 0,
    },
    W = (e) => Je[typeof e](e),
    M = class extends ye.EventEmitter {
      constructor(t) {
        (super(),
      ...
      _nextSend() {
        ...
        return new Promise((i, a) => {
          ...
          try {
            let l = t.map((f) => ({
              ...f,
              payload: { data: f.payload, eventResponseKey: r },
            }));
            this.wall.send(l);
          } catch (l) {
            ...
            if (l.message === f && Array.isArray(n.payload)) {
              let m = W(n);
              if (m > this._maxMessageSize) {
                let g = Math.ceil(m / this._maxMessageSize),
                  h = Math.ceil(n.payload.length / g),
                  w = n.payload;
                for (let k = 0; k < g; k++) {
                  let H = Math.min(w.length, h);
                  this.wall.send([
                    {
                      event: n.event,
                      payload: {
                        _chunkSplit: { count: g, lastChunk: k === g - 1 },
                        data: w.splice(0, H),
                      },
                    },
                  ]);
  ...
  var $e = chrome.runtime.getURL("assets/config.js"),
    ve,
    E = (ve = globalThis.browser) != null ? ve : globalThis.chrome;
  async function Ze() {
    var ee, te;
    let e = await E.storage.local.get("defaultConfig");
    if ((ee = e.defaultConfig) != null && ee.apiKey) return e.defaultConfig;
    let t = {},
      ...
      r = /\/\*[\s\S]*?\*\/|([^:]|^)\/\/.*$/gm,
      s = (await (await fetch($e)).text()).replace(r, ""),
      u = s.slice(s.indexOf("{") + 1, s.lastIndexOf("}")),
      l = JSON.stringify(u)
        .replaceAll('\\"', "'")
        .replaceAll("\\n", "")
        .replaceAll('"', "")
    ...
    (l
      ...
      .forEach((De) => {
        let [_, ne] = De.split(":");
        if (_ && ne) {
          let L = ne.replaceAll("'", "").replaceAll('"', "");
          for (let b = 0; b < n.length; b++)
            _.endsWith(n[b]) && (L = Number(L));
          for (let b = 0; b < o.length; b++)
            _.startsWith(o[b]) && (L = L === "true");
          t[_] = L;
        }
      }),
      (h = h.replaceAll("'", "").replaceAll('"', "")));
    let H = h.indexOf(":["),
      Ie = h.slice(H + 2, h.length - 1);
    t.blackUrlList = Ie.split(",");
    let A = await E.storage.local.get("config");
    return (
      (te = A == null ? void 0 : A.config) != null &&
        te.apiKey &&
        (t.apiKey = A.config.apiKey),
      E.storage.local.set({ defaultConfig: t }),
      t
    );
  }
  var T = {
  ...
  async function xe() {
    ...
    for (let n of t)
      if (!(n === "proxyType" && !Ce[n].includes(e[n]))) {
        ...
        Reflect.has(T, n) && typeof T[n] == typeof e[n] && (T[n] = e[n]);
      }
    return T;
  }
  var et = xe(),
    R = {
      ...
      async getAll() {
        let e = await xe(),
          t = await E.storage.local.get("config");
        return R.joinConfig(e, t.config);
      },
      async set(e) {
        let t = await R.getAll(),
          n = R.joinConfig(t, e);
        return E.storage.local.set({ config: n });
      },
      joinConfig(e, t) {
        let n = {};
    ...
    return new Promise((t, n) => {
      ...
      ((o.src = e),
        ...
        (o.onload = () => {
          ...
          ((r.width = o.width),
            (r.height = o.height),
            r.getContext("2d").drawImage(o, 0, 0, o.width, o.height));
          let a = r.toDataURL();
          t(a);
        }),
        (o.onerror = (r) => {
  ...
  function nt(e, t, n = 30) {
    ...
    for (let m = 0; m < n; ++m)
      (o.push(r),
        m < (n * 1) / 10
          ? (i += p(60, 100))
          : m >= (n * 9) / 10 && ((i -= p(60, 100)), (i = Math.max(20, i))),
        (r += i));
    let a = [],
      s = [e.x, e.y],
  ...
  function rt({ x: e, y: t }) {
    document.body.dispatchEvent(
      new MouseEvent("mousedown", { bubbles: !0, clientX: e, clientY: t }),
    );
  }
  function it({ x: e, y: t }) {
    document.body.dispatchEvent(
      new MouseEvent("mouseup", { bubbles: !0, clientX: e, clientY: t }),
    );
  }
  async function at(e, t) {
    (ot(e, t), await y(p(30, 80)), rt(t), await y(p(30, 80)), it(t));
  }
  async function st(e) {
    for (let t = 0; t < e.length - 1; t++) await at(e[t], e[t + 1]);
  }
  function ct(e, t, n) {
    let r = [
      n
        ? K(n)
        : { x: t ? p(420, 530) : p(10, 100), y: t ? p(200, 300) : p(5, 200) },
    ];
  ...
  var Le = ["Error: ERROR_UNSUPPORTED_QUESTION"];
  var Q = "",
    B = [],
    V = -1,
    F = 0,
    ...
    z = !1;
  var Ee,
    zt = (Ee = globalThis.browser) != null ? Ee : globalThis.chrome;
  function lt() {
    return (
      document.querySelector(".rc-imageselect-error-select-more").style
        .display !== "none"
    );
  }
  function ut() {
    return (
      document.querySelector(".rc-imageselect-error-dynamic-more").style
        .display !== "none"
    );
  }
  async function Me() {
    let e = Array.from(document.querySelectorAll(".rc-imageselect-tile")),
      t = p(0, e.length);
    (e[t].click(), await D([e[t]], x), (x = e[t]), Re());
  }
  function ft() {
    var t;
    let e =
      ((t = document.querySelector("#recaptcha-anchor")) == null
        ? void 0
        : t.getAttribute("aria-checked")) === "true";
    return (
      e &&
        ((S = 0),
        !z && chrome.runtime.sendMessage({ action: "solved" }),
        (z = !0)),
      e
    );
  }
  ...
  async function Te(e) {
    let t = await we(e.image),
      n = { image: t.slice(t.indexOf(";base64,") + 8), question: e.question };
    (e.index && (n.index = e.index),
      chrome.runtime
        .sendMessage({ action: "solver", captchaType: "reCaptcha", params: n })
        .then((o) => {
          var r, i;
          if (
            !(o != null && o.response) ||
            ((r = o == null ? void 0 : o.response) == null ? void 0 : r.error)
          ) {
            (Le.includes(
              (i = o == null ? void 0 : o.response) == null ? void 0 : i.error,
            ) && ht(),
              (Q = ""),
              S++);
            return;
  ...
  async function Re() {
    var e;
    ((V === 3 && F === 0 && (await j())) || V === 4) &&
      ((e = document.querySelector("#recaptcha-verify-button")) == null ||
        e.click(),
      (x = null),
      (B = []),
      v.shift(),
      await D([document.querySelector("#recaptcha-verify-button")], x));
  }
  function G() {
  ...
  function J(e) {
    return new Promise((t) => {
      ...
      let o = Array.from(document.querySelectorAll(".rc-imageselect-tile img")),
        ...
        s = !1,
        u = "";
      (r !== 9 && r !== 16 && t(!1), (V = r === 9 ? 3 : 4));
      for (let l = 0; l < r; l++) {
        let f = o[l];
        f.naturalWidth >= 300
          ? (a = f.getAttribute("src"))
          : f.naturalWidth === 100 &&
            ((i[l] = f.getAttribute("src")), (s = !0));
      }
      (s && (a = null),
        (u = JSON.stringify([a, i])),
        Q === u && t(!1),
        (Q = u),
        (F = 0),
        t({ question: n, url: a, urls: i }));
    });
  }
  async function $(e) {
    pt() && S++;
    let { question: t, url: n, urls: o } = e,
      r = "";
    if (n) ((r = n), await Te({ question: t, image: r }));
    else
      for (let i = 0; i < o.length; i++)
        !o[i] ||
          ...
          ((r = o[i]),
          B.push(r),
          await Te({ question: t, image: r, index: i }));
  }
  async function gt(e) {
    var r;
    let t = (r = e == null ? void 0 : e.response) == null ? void 0 : r.solution;
    if (!t) return;
    let n = Array.from(document.querySelectorAll(".rc-imageselect-tile")),
      o = [];
    if (t.type === "single")
      t.hasObject
        ? (F++, n[e.index].click(), B.splice(e.index, 1), o.push(n[e.index]))
        : (F = 0);
    else {
      let i = t.objects,
        a = i.length;
      for (let s = 0; s < a; s++)
        (await y(100), n[i[s]].click(), o.push(n[i[s]]));
    }
    (await D(o, x), (x = o[o.length - 1]), await y(500), Re());
  }
  function Se(e) {
    let t = e.length,
      n = [];
    for (let o = 0; o < t; o++)
      if (Array.isArray(e[o]) && e[o][0] !== "pmeta") n = Se(e[o]);
...
`)[1],
  ...
  Ae.src = chrome.runtime.getURL("assets/inject/inject-recaptcha.js");
  var yt = document.head || document.documentElement;
  yt.appendChild(Ae);
  window.addEventListener("message", function (e) {
    var t, n;
    (((t = e == null ? void 0 : e.data) == null ? void 0 : t.type) === "xhr" ||
      ((n = e == null ? void 0 : e.data) == null ? void 0 : n.type) ===
        "fetch") &&
      ke(e.data.data);
  });
  async function bt(e) {
    !e.useCapsolver ||
      !e.enabledForRecaptcha ||
      !e.apiKey ||
      (e.enabledForBlacklistControl && e.isInBlackList) ||
      e.reCaptchaMode !== "click" ||
      (await y(e.reCaptchaDelayTime),
      setInterval(async () => {
        if ((G() && X(), Y())) {
          if (!(await j())) return;
  ...
  var _e = (e) => {};
  var Z = chrome.runtime.connect({ name: "contentScript" }),
    Pe = !1;
  ...
  var Oe = new M({
    ...
    send(e) {
      Pe ||
        (Z.postMessage(e),
        window.postMessage({ ...e, from: "bex-content-script" }, "*"));
    },
  });
  function vt(e) {
  ...
  document instanceof HTMLDocument && vt(chrome.runtime.getURL("assets/dom.js"));
  be(Oe, "bex-dom");
  _e(Oe);
})();
});