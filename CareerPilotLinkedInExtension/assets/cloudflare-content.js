...
(() => {
    ...
    if ((t && typeof t == "object") || typeof t == "function")
      for (let o of pe(t))
        !me.call(e, o) &&
          ...
          K(e, o, {
            get: () => t[o],
            enumerable: !(r = de(t, o)) || r.enumerable,
          });
    return e;
  };
  var ye = (e, t, n) => (
  ...
  var X = ge((Ie, O) => {
    ...
    a.prototype.emit = function (t) {
      ...
      if (typeof f == "function") U(f, this, n);
      else
        for (var u = f.length, d = G(f, u), r = 0; r < u; ++r) U(d[r], this, n);
      return !0;
    };
    function z(e, t, n, r) {
      var o, s, i;
    ...
    a.prototype.once = function (t, n) {
      return (S(n), this.on(t, q(this, t, n)), this);
    };
    a.prototype.prependOnceListener = function (t, n) {
      return (S(n), this.prependListener(t, q(this, t, n)), this);
    };
    a.prototype.removeListener = function (t, n) {
      var r, o, s, i, c;
      if ((S(n), (o = this._events), o === void 0)) return this;
      ...
      if (r === n || r.listener === n)
        ...
        (s === 0 ? r.shift() : be(r, s),
          ...
          o.removeListener !== void 0 &&
            this.emit("removeListener", t, c || n));
      }
      return this;
    };
    ...
    function Le(e, t) {
      return new Promise(function (n, r) {
        ...
        (J(e, t, s, { once: !0 }), t !== "error" && ke(e, o, { once: !0 }));
      });
    }
    function ke(e, t, n) {
      typeof e.on == "function" && J(e, "error", t, n);
    }
    function J(e, t, n, r) {
  ...
  var _e = (() => {
    ...
    Y = 4096;
  function Z() {
    (j === void 0 || T + 16 > Y) && ((T = 0), (j = _e(Y)));
    let e = Array.prototype.slice.call(j, T, (T += 16));
    return (
      (e[6] = (e[6] & 15) | 64),
      (e[8] = (e[8] & 63) | 128),
      l[e[0]] +
  ...
  var Ee = {
      ...
      string: (e) => 2 * e.length,
      object: (e) =>
        e ? Object.keys(e).reduce((t, n) => B(n) + B(e[n]) + t, 0) : 0,
    },
    B = (e) => Ee[typeof e](e),
    x = class extends ee.EventEmitter {
      constructor(t) {
        (super(),
      ...
      on(t, n) {
        return super.on(t, (r) => {
          n({ ...r, respond: (o) => this.send(r.eventResponseKey, o) });
        });
      }
      _emit(t) {
          ...
          let c = [],
            f = (u) => {
              if (u !== void 0 && u._chunkSplit) {
                let d = u._chunkSplit;
                ((c = [...c, ...u.data]),
                  d.lastChunk && (this.off(o, f), s(c)));
              } else (this.off(o, f), s(u));
            };
          this.on(o, f);
          try {
            let u = t.map((d) => ({
              ...d,
              payload: { data: d.payload, eventResponseKey: o },
            }));
            this.wall.send(u);
          } catch (u) {
            ...
            if (u.message === d && Array.isArray(n.payload)) {
              let y = B(n);
              if (y > this._maxMessageSize) {
                let m = Math.ceil(y / this._maxMessageSize),
                  p = Math.ceil(n.payload.length / m),
                  A = n.payload;
                for (let L = 0; L < m; L++) {
                  let R = Math.min(A.length, p);
                  this.wall.send([
                    {
                      event: n.event,
                      payload: {
                        _chunkSplit: { count: m, lastChunk: L === m - 1 },
                        data: A.splice(0, R),
                      },
                    },
                  ]);
  ...
  var Se = chrome.runtime.getURL("assets/config.js"),
    re,
    w = (re = globalThis.browser) != null ? re : globalThis.chrome;
  async function Te() {
    var I, F;
    let e = await w.storage.local.get("defaultConfig");
    if ((I = e.defaultConfig) != null && I.apiKey) return e.defaultConfig;
    let t = {},
      ...
      o = /\/\*[\s\S]*?\*\/|([^:]|^)\/\/.*$/gm,
      c = (await (await fetch(Se)).text()).replace(o, ""),
      f = c.slice(c.indexOf("{") + 1, c.lastIndexOf("}")),
      u = JSON.stringify(f)
        .replaceAll('\\"', "'")
        .replaceAll("\\n", "")
        .replaceAll('"', "")
    ...
    (u
      ...
      .forEach((ue) => {
        let [_, N] = ue.split(":");
        if (_ && N) {
          let C = N.replaceAll("'", "").replaceAll('"', "");
          for (let h = 0; h < n.length; h++)
            _.endsWith(n[h]) && (C = Number(C));
          for (let h = 0; h < r.length; h++)
            _.startsWith(r[h]) && (C = C === "true");
          t[_] = C;
        }
      }),
      (p = p.replaceAll("'", "").replaceAll('"', "")));
    let R = p.indexOf(":["),
      le = p.slice(R + 2, p.length - 1);
    t.blackUrlList = le.split(",");
    let k = await w.storage.local.get("config");
    return (
      (F = k == null ? void 0 : k.config) != null &&
        F.apiKey &&
        (t.apiKey = k.config.apiKey),
      w.storage.local.set({ defaultConfig: t }),
      t
    );
  }
  var b = {
  ...
  async function oe() {
    let e = await Te(),
      t = Object.keys(e);
    for (let n of t)
      if (!(n === "proxyType" && !ne[n].includes(e[n]))) {
        {
          if (n.endsWith("Mode") && !ne.mode.includes(e[n])) continue;
          if (n === "port") {
  ...
  var Me = oe(),
    v = {
      ...
      async getAll() {
        let e = await oe(),
          t = await w.storage.local.get("config");
        return v.joinConfig(e, t.config);
      },
      async set(e) {
        let t = await v.getAll(),
          n = v.joinConfig(t, e);
        return w.storage.local.set({ config: n });
      },
      joinConfig(e, t) {
        let n = {};
        if (e) for (let r in e) n[r] = e[r];
  ...
  function ie() {
    ...
    return (
      r.classList.add("capsolver-solver-info"),
      (r.innerText = "solving"),
      e.appendChild(t),
      e.appendChild(r),
      e
  ...
  function M(e, t) {
    let n = document.querySelector("#capsolver-solver-tip-button"),
      r = n == null ? void 0 : n.querySelector(".capsolver-solver-info");
    (r && (r.innerHTML = e), t && n && (n.dataset.state = t));
  }
  var P = "";
  function Ae() {
    let e = document.createElement("script");
    e.src = chrome.runtime.getURL("assets/inject/inject-turnstile.js");
    let t = document.head || document.documentElement;
    t.insertBefore(e, t.firstChild);
  }
  async function Re(e) {
    let t = await v.getAll();
    if (t.showSolveButton) {
      let n = ie();
      if (
        (n.setAttribute(
          "style",
          "position: fixed;right: 20px; bottom: 180px;min-width:220px;",
        ),
        document.body.appendChild(n),
        !t.apiKey || (t.enabledForBlacklistControl && t.isInBlackList))
      ) {
        M("Please input your API key!", "error");
        return;
      }
    }
    t.manualSolving
      ...
      : chrome.runtime
          ...
          .then((n) => {
            ...
            ((o =
              ...
              (window == null ||
                window.postMessage({
                  type: "turnstileSolved",
                  token:
                    (i =
                      (s = n == null ? void 0 : n.response) == null
                        ? void 0
                        : s.response) == null
                      ? void 0
                      : i.code,
  ...
  window.addEventListener("message", async function (e) {
    var t;
    if (
      !!["registerTurnstile", "capsolverSolve"].includes(e.data.type) &&
      !(!((t = e.data) != null && t.sitekey) && !P)
    ) {
      if (e.data.type === "registerTurnstile") {
        Re(e);
        return;
      }
      chrome.runtime
  ...
  async function Oe() {
    let e = await v.getAll();
    !e.useCapsolver || !e.enabledForCloudflare || Ae();
  }
  Oe();
  function je() {
    let e = document.querySelector(".cf-turnstile");
    if (!e) return null;
    let t = e.getAttribute("data-sitekey"),
      n = e.getAttribute("data-action"),
      r = e.getAttribute("data-cdata"),
      o = document.location.href;
    return { sitekey: t, action: n, cData: r, website: o };
  }
  function Be() {
    let e = Array.from(document.querySelectorAll("iframe[src]")),
      t = "";
    e.forEach((o) => {
      o.src.startsWith(
  ...
  chrome.runtime.onMessage.addListener((e, t, n) => {
    if ((e == null ? void 0 : e.command) === "get-cloudflare-info") {
      let r = { sitekey: "", website: document.location.href },
        o = je();
      if (!o || !o.sitekey) {
        ((r.sitekey = Be()), n(r));
        return;
  ...
  var se = (e) => {};
  var D = chrome.runtime.connect({ name: "contentScript" }),
    ae = !1;
  ...
  document instanceof HTMLDocument && Pe(chrome.runtime.getURL("dom.js"));
  te(ce, "bex-dom");
  se(ce);
})();
});