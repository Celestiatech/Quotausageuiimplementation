...
(() => {
  ...
  var ae = (e, t, r) => (
    ...
    ie(
      t || !e || !e.__esModule
        ? _(r, "default", { value: e, enumerable: !0 })
        : r,
      e,
    )
  );
  var O = oe((Ce, C) => {
    ...
    function fe(e, t) {
      return new Promise(function (r, n) {
        ...
        (H(e, t, i, { once: !0 }), t !== "error" && pe(e, o, { once: !0 }));
      });
    }
    function pe(e, t, r) {
  ...
  var me = {
    ...
    g = class extends N.EventEmitter {
      ...
      send(t, r) {
        return this._send([{ event: t, payload: r }]);
      }
      getEvents() {
        return this._events;
      }
      on(t, r) {
        return super.on(t, (n) => {
          r({ ...n, respond: (o) => this.send(n.eventResponseKey, o) });
        });
      }
      _emit(t) {
      ...
      _nextSend() {
        ...
        return new Promise((i, a) => {
          ...
          try {
            let s = t.map((u) => ({
              ...u,
              payload: { data: u.payload, eventResponseKey: o },
            }));
            this.wall.send(s);
          } catch (s) {
                  ...
                  this.wall.send([
                    {
                      event: r.event,
                      payload: {
                        _chunkSplit: { count: m, lastChunk: x === m - 1 },
                        data: T.splice(0, J),
                      },
                    },
                  ]);
              ...
              for (let p in s[u]) {
                ...
                if (p === "bind" && s[u][p])
                  if (typeof s[u][p] == "string") o.bindedButtonId = s[u][p];
                    ...
                    let m = s[u][p];
                    (m.id === void 0 &&
                      (m.id = "recaptchaBindedElement" + n.id),
