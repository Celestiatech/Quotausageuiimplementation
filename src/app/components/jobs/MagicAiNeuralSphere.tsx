...
import {
  MagicAiJobContext,
  MagicAiUserProfile,
  MagicAiPipelineStats,
  AgentNodeKey,
} from "./MagicAiDecisionModal";

export interface MagicAiNeuralSphereProps {
  isOpen?: boolean;
  onClose?: () => void;
...
export const MagicAiNeuralSphere: React.FC<MagicAiNeuralSphereProps> = ({
  isOpen = true,
  onClose = () => {},
  targetJob,
  userProfile,
  ...
  return (
    <AnimatePresence>
      <div className="relative w-full max-w-6xl my-auto flex flex-col items-center justify-center font-sans select-none">
          ...
          {isCardMinimized ? (
            ...
            >
              ...
              <div className="space-y-2">
                ...
                {/* CHOICE 1: 🌟 Auto-Optimize & Continue */}
                <button
                  type="button"
        ...
        {/* DEDICATED LIVE AGENT INSPECTOR DRAWER */}
        <AnimatePresence>
...
export default MagicAiNeuralSphere;
